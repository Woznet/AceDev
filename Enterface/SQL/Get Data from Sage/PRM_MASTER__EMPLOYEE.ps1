...
$sqlcmd = "select e.Employee EmployeeCode,e.Employee_Name FirstName,'' MiddleName,'' LastName,'True' IsActive,1 CompanyId,e.Certified_Class EmployeeType,e.Pay_ID CompCode,e.Pay_Group PayGroup,'' PayPeriod,'' PayRate1,'' PayRate2,e.Employee SOURCE_KEY from PRM_MASTER__EMPLOYEE e"
...
$results4 | Export-Csv -Path C:\temp\Sage-to-csv\PRM_MASTER__EMPLOYEE.csv -NoTypeInformation -Verbose