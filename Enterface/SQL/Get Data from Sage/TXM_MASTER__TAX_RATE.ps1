...
$sqlcmd = 'select Tax Tax_Group,Description,Tax_Percent Tax_Rate,State,Tax SOURCE_KEY from TXM_MASTER__TAX_RATE'
...
$results4 | Export-Csv -Path C:\temp\Sage-to-csv\TXM_MASTER__TAX_RATE.csv -NoTypeInformation -Verbose