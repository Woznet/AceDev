...
$sqlcmd = 'select Tax_Group,Description,Total_Group_Percent Tax_Percent,State,Tax_Group SOURCE_KEY from TXM_MASTER__TAX_GROUP'
...
$results4 | Export-Csv -Path C:\temp\Sage-to-csv\TXM_MASTER__TAX_GROUP.csv -NoTypeInformation -Verbose